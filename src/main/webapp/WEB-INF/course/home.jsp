        ...
        <div class="layui-side layui-bg-black kit-side">
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="kitNavbar" kit-navbar>
                    <li class="layui-nav-item">
                        <a class="" href="javascript:;"><i class="fa fa-plug" aria-hidden="true"></i><span> 助教操作</span></a>
                        <dl class="layui-nav-child">
                            <dd>
                                <a href="javascript:;" data-url="add" data-icon="fa-user" data-title="推送课程" kit-target data-id='2'><i class="fa fa-user" aria-hidden="true"></i><span> 推送课程</span></a>
                            </dd>
                            <dd>
                                <a href="javascript:;" data-url="showdata" data-icon="&#xe628;" data-title="查看课程" kit-target data-id='3'><i class="layui-icon">&#xe628;</i><span> 查看课程</span></a>
                            </dd>
                            <dd>
